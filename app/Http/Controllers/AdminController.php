...
class AdminController extends Controller implements FromQuery
{
	use Exportable;
	...
	public function query(){
		...
		return Orders::with('category')::query();
	...
	public function orders_report(){
		return (new AdminController)->download('orders_statement.xlsx');
	}
